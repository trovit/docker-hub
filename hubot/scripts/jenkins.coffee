...
module.exports = (robot) ->
  ...
  robot.respond /d(?:eploy)? rtb-board/i, (msg) ->
    jenkinsBuild(shortcut(msg, "rtb-board-deployment"), false)

  robot.respond /d(?:eploy)? distribution/i, (msg) ->
    robot.logger.info msg
    jenkinsBuild(shortcut(msg, "rtb-distribution-files-deployment"), false)
